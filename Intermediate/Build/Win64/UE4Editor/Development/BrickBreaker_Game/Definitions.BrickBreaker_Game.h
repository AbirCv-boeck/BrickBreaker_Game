...
#define UE_PROJECT_NAME BrickBreaker_Game
#define UE_TARGET_NAME BrickBreaker_GameEditor
#define UE_MODULE_NAME "BrickBreaker_Game"
...
#define BRICKBREAKER_GAME_API DLLEXPORT
